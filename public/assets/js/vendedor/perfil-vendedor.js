    ...
    $('#form-salvar-infoloja').submit(() => {
        ...
        jQuery.ajax({
            type: "POST",
            url: '/usuarios/salvarperfil-loja',
            data: {
                id: id, nomeloja: nomeloja, Tipopessoa: Tipopessoa, rzsocial: rzsocial, nomecompleto: nomecompleto, cnpj: cnpj, cpf: cpf, telcomercial: telcomercial,
                ...
                instagram: instagram, facebook: facebook, whatsapp: whatsapp, validate: validate
            },
            ...
            success: function (response) {
                ...
                if (response.responseid == 200) {
                    $(document).ready(() => {
                        Swal.fire({
                            toast: true,
                            title: '<i style="color:white">Dados alterados com sucesso!</i>',
